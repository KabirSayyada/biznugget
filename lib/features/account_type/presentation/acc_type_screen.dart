...
import 'package:biznugget/features/account_type/presentation/freelancer_jobs.dart';
import 'package:biznugget/features/account_type/presentation/service_provider.dart';
            ...
            AccountTypeCard(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const ServiceProviders()));
              },
            ),
            AccountTypeCard(
